<?php	
	...
	define("DEFPHP_PATH", rtrim(DEFPHP, '/').'/');     //BroPHP框架的路径
	define("APP_PATH", rtrim(APP,'/').'/');            //用户项目的应用路径
	define("PROJECT_PATH", dirname(DEFPHP_PATH).'/');  //项目的根路径，也就是框架所在的目录
	...
	if(defined("DEBUG") && DEBUG==1){
		...
		include DEFPHP_PATH."bases/debug.class.php";  //包含debug类
	...
	//包含框架中的函数库文件
	include DEFPHP_PATH.'commons/functions.inc.php';
	...
	$include_path.=PATH_SEPARATOR.DEFPHP_PATH."bases/";       //框架中基类所在的目录
	$include_path.=PATH_SEPARATOR.DEFPHP_PATH."classes/" ;    //框架中扩展类的目录
	$include_path.=PATH_SEPARATOR.DEFPHP_PATH."libs/" ;       //模板Smarty所在的目录
